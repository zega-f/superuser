...
use Zoom\php\src\BeforeValidException;
use Zoom\php\src\ExpiredException;
use Zoom\php\src\SignatureInvalidException;
use Zoom\php\src\JWT;
...
class Zoom_Api
{
	private $zoom_api_key = 'TN-DBcc2TECFAw6H4Qk4SQ';
	private $zoom_api_secret = 'XAkcpRfWYc6tWSa5OCEGjdVRtH8FWymhd8aA';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/fauzytamimkdr@gmail.com/meetings";
