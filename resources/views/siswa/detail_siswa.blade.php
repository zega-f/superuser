...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ url('data_siswa') }}">Siswa Reguler</a></li>
...
<div class="card">
    <div class="card-header bg-info">
        <h3 class="card-title"><b>Profil Siswa</b></h3>
    </div>
<div class="card-body">
<div class="col-12">
      ...
      <div class="card-body pt-0">
        ...
        <div class="col-sm-10 col-md-5" style="line-height: 12px;">
            ...
            <tbody>
                ...
                <p class="text-muted text-md"><tr><td><b>Kelas</b></td><td><b>:</b></td><td> &nbsp;{{ $item->tingkat }}{{ $item->room_name }}</td></tr></p>
                <?php
