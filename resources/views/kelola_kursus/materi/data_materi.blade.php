...
{{-- @foreach ($sub_bab as $item) --}}
    <table class="table table-striped materi_box{{$item->type_id}}" id="materi_box{{$item->type_id}}">
        ...
        <td class="float-right">
            <a href="#" id="preview_materi{{$item->type_id}}" class="btn btn-sm btn-info ion-eye" data-id_materi="{{$item->id}}" data-toggle="modal" data-target="#modal-preview_materi{{$item->type_id}}" data-toggle="tooltip" data-placement="right" title="Lihat Materi"></a>
            <a href="{{url('edit_materi_kursus/'.$item->type_id.'/'.$item->room_id.'/'.$item->bab_id)}}" class="btn btn-primary btn-sm ion-edit" data-toggle="tooltip" data-placement="right" title="Edit Materi"></a>
            <button class="btn btn-sm btn-danger ion-trash-b" data-toggle="tooltip" data-placement="bottom" title="Hapus materi" data-id="{{$item->type_id}}" data-bab="{{$item->bab_id}}" data-kelas="{{$item->room_id}}" data-mapel="{{$item->mapel}}" data-toggle="tooltip" data-placement="right" title="Hapus Materi"></button>   
