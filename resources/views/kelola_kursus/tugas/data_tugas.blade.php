...
<table class="table table-striped tugas_box{{$item->type_id}}" id="tugas_box{{$item->type_id}}">
    <tr>
        ...
        <td class="float-right">
            <a href="#" id="preview_tugas{{$item->type_id}}" class="btn btn-sm btn-info ion-eye" data-id_materi="{{$item->id}}" data-toggle="modal" data-target="#modal-preview_tugas{{$item->type_id}}" data-toggle="tooltip" data-placement="right" title="Lihat Tugas"></a>
            <a href="{{url('edit_tugas_kursus/'.$item->type_id.'/'.$item->room_id.'/'.$item->bab_id)}}" class="btn btn-primary btn-sm ion-edit" data-toggle="tooltip" data-placement="right" title="Edit Tugas"></a>
