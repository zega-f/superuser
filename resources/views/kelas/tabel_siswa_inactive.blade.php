    ...
    ?>
        <tr id="row{{$data->user_id}}">
            ...
            <td>{{ $data->name }}</td>
                ...
                <td align="center"><button class="btn btn-success btn-sm add_2_class" id="add_2_class{{$data->user_id}}" data-idsiswa="{{$data->user_id}}" data-id_kelas="{{ $data->room_id }}" data-toggle="tooltip" data-placement="right" title="Tambahkan Siswa ke Kelas ini" style="padding:5px !important; font-size:12px !important;">Add</button></td>
            </td>
...
<script type="text/javascript">
	$('.add_2_class').click(function(){
        ...
        {
            toastr.success('Berhasil Memasukkan Siswa')
