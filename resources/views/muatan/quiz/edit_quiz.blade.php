	...
	<div class="card">
		<div class="card-header">
			<h5 class="card-title" style="font-size:16px;">
				<b>Kelola Quiz {{ $this_quiz->mapel }} {{ $this_quiz->tingkat }}</b>
			</h5>

			<span style="float: right; font-size: 14px; font-weight: normal;">
				<a href="{{ url('kelola_mapelkelas/'.$this_quiz->room_id.'/'.$this_quiz->mapel_id)}}" class="btn btn-sm btn bg-orange" style="color: white;">
					Menu Bab <i class="bi bi-check-square"></i>
				</a>
		...
		<div class="card-body">
			<table class="table">
				<tr>
					<td>Nama Quiz</td>
					<td><input type="text" name="nama" id="nama_materi" class="form-control" requiredplaceholder="E.g. Quiz akhir tahun" value="{{$this_quiz->quiz_name}}">
