...
<table class="table table-striped quiz_box{{$item->type_id}}" id="quiz_box{{$item->type_id}}">
    <tr>
        ...
        <td class="float-right">
            <a href="#" id="preview_quiz{{$item->type_id}}" class="btn btn-sm btn-info ion-eye" data-id_quiz="{{$item->id}}" data-toggle="modal" data-target="#modal-preview_quiz{{$item->type_id}}" data-toggle="tooltip" title="Lihat Quiz"></a>
            <a href="{{url('edit_quiz/'.$item->type_id)}}" class="btn btn-primary btn-sm ion-edit" data-toggle="tooltip" title="Edit Quiz"></a>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('kelola_mapel.quiz.preview_quiz') 
            </div>
        </div>
    </div>
</div>
